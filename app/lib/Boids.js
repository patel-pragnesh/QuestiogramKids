...
module.exports = function (opts, callback) {
	...
	for (var i = 0, l = sprites.length; i < l; i += 1) {
		boids[i] = [
			Math.random()*25, // x
			Math.random()*25, // y
			10, 10,  // speed
		...
		sprites[i].x = boids[i][POSITIONX];
		sprites[i].y = boids[i][POSITIONY];
	}
	...
	BoidGroup.setAttractors = function(_attractors){
		console.log('setAttractors')
