...
// Screen constants:
var SCREEN_H = Alloy.Globals.gameView.screen.height;
var SCREEN_W = Alloy.Globals.gameView.screen.width;
var SCREEN_HALF_H = SCREEN_H*0.5;
var SCREEN_HALF_W = SCREEN_W*0.5;
...
exports.create = function(args){
	...
	if(args.borderWall){
		...
		var walls = [/*{start:{x:leftWallOffset,y:cpY(0)},end:{x:leftWallOffset,y:0}},                   // Left wall
		             ...
		             {start:{x:-SCREEN_W,y:groundWallOffset},end:{x:cpX(0),y:groundWallOffset}}];              // Ground
...
exports.addDynamicCircleBody = function(args){
	...
	var radius = args.sprite.width * 0.5;
	var mass = args.mass || 1;
